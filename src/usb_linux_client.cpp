...
static struct func_desc fs_descriptors = {};
    fs_descriptors.intf = {};
        fs_descriptors.intf.bLength = sizeof(.fs_descs.intf);
    ...
    fs_descriptors.intf.source = {};
        fs_descriptors.source.bLength = sizeof(descriptors.fs_descs.source);
	...
	fs_descriptors.sink. = {};
        fs_descriptors.sink.bLength = sizeof(descriptors.fs_descs.sink);
